...
class MEMCardForm(forms.Form):
    ...
    memcard_url = forms.URLField(label='Enter Valid URL', max_length=100)
    memcard_city = forms.CharField(label='Enter City Name', max_length=100)
    memcard_country = forms.CharField(label='Enter Country Name', max_length=100)
...
class vCardForm(forms.Form):
    ...
    vcard_nick_name=forms.CharField(label='Enter Nick Name', max_length=100)
    vcard_phone = forms.CharField(label='Enter Phone No', max_length=100)
    vcard_email = forms.EmailField(label="Enter Email ID")
    vcard_fax = forms.CharField(label='Enter Fax', max_length=100)
    vcard_url = forms.URLField(label='Enter Valid URL', max_length=100)
    vcard_street = forms.CharField(label='Enter Street Address', max_length=100)
    vcard_city = forms.CharField(label='Enter City Name', max_length=100)
    vcard_country = forms.CharField(label='Enter Country Name', max_length=100)
    vcard_zipcode = forms.CharField(label='Enter Zip Code', max_length=100)
    vcard_lat = forms.FloatField(label='Enter Latitude',max_value=10, min_value=0)
    vcard_lng = forms.FloatField(label='Enter longitude',max_value=10, min_value=0)
